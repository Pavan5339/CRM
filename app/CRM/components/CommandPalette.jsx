...
const PAGES = [
  ...
  { label: 'Lead Tracking', path: '/CRM/leads', icon: Users },
  { label: 'Activities', path: '/CRM/activities', icon: Activity },
  { label: 'Tasks', path: '/CRM/tasks', icon: CheckSquare },
  { label: 'Follow-ups', path: '/CRM/followups', icon: Calendar },
  { label: 'Calendar', path: '/CRM/calendar', icon: Calendar },
  { label: 'Products', path: '/CRM/products', icon: Package },
  { label: 'Customers', path: '/CRM/customers', icon: UserCircle },
  { label: 'Lead Sources', path: '/CRM/sources', icon: LinkIcon },
  { label: 'Email Templates', path: '/CRM/templates', icon: Mail },
  { label: 'Campaigns', path: '/CRM/campaigns', icon: Zap },
  { label: 'Settings', path: '/CRM/settings', icon: Settings },
  { label: 'AI Assistant', path: '/CRM/ai-assistant', icon: Bot },
];
